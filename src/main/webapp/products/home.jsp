            ...
            <C:forEach items="${products}" var="products">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="https://chiinstore.com/media/news/13_untitled.png" alt="..."/>
                        <!-- Product details-->
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="${products.img}">Xem them</a>
                            </div>
                        </div>
                    </div>
                </div>
